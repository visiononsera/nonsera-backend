import { annoncesService } from "../services/annonces.service.js";
export const annoncesController = {
    ...
    getMany: async (req, res, next) => {
        try {
            ...
            const filters = {
                ...(req.query.companyId ? { companyId: parseInt(req.query.companyId, 10) } : {}),
                ...(req.query.category ? { category: req.query.category } : {}),
                ...(req.query.vehicleType ? { vehicleType: req.query.vehicleType } : {}), // Typage énum Prisma à valider
            ...
            const pagination = {
                ...
                ...(req.query.page ? { page: parseInt(req.query.page, 10) } : {}),
            };
