...
import { Pool } from "pg";
// Correction du warning SSL pour standardiser avec Neon
...
const SYSTEM_PERMISSIONS = [
    {
        ...
        description: "Créer, modifier, afficher et supprimer les comptes du personnel.",
    },
    {
    ...
    },
    {
        ...
        description: "Créditer manuellement le compte d'un client venant en agence.",
    },
    {
        ...
        for (const gender of genders) {
            for (let i = 0; i < 10; i++) {
                ...
                if (i <= 3)
                    ...
                    onboardingStep = "CALL_VALIDATION";
                let phoneNumber = `${data.prefix}${gender === "MALE" ? "90" : "91"}00000${i}`;
                if (countryName === "Benin" && i === 0)
                    onboardingStep = "COMPLETED";
...
async function seedCompanies() {
    ...
    const rawCompanies = [
        ...
        }, // Redirigé vers Parakou pour cohérence coords
        {
            ...
            await safeTransaction(async (tx) => {
                ...
                await tx.annonce.create({
                    data: {
                        ...
                        equipements: raw.category === "HOTEL"
